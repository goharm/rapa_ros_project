...
# audio = stream = p.open(format=pyaudio.paInt16,channels=1,rate=RATE,input=True,frames_per_buffer=CHUNK)
audio = stream = p.open(format=p.get_format_from_width(width=2),
                channels=1,
                rate=RATE,
                output=True)
